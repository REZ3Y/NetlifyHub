...
/**
 * Returns `fetch` that routes HTTPS through the user's outbound proxy when enabled.
 */
export async function createOutboundFetchForUser(env: Env, userId: string): Promise<typeof fetch> {
